...
public class TablesTest extends RenderingTestCase {
    ...
    public void sourceSpans() {
        ...
        assertThat(block.getSourceSpans(), contains(SourceSpan.of(1, 1, 7), SourceSpan.of(2, 1, 7),
                SourceSpan.of(3, 1, 4), SourceSpan.of(4, 2, 8), SourceSpan.of(5, 1, 3)));
        ...
        assertThat(body.getSourceSpans(), contains(SourceSpan.of(3, 1, 4), SourceSpan.of(4, 2, 8), SourceSpan.of(5, 1, 3)));

        TableRow bodyRow1 = (TableRow) body.getFirstChild();
        assertThat(bodyRow1.getSourceSpans(), contains(SourceSpan.of(3, 1, 4)));
        TableCell bodyRow1Cell1 = (TableCell) bodyRow1.getFirstChild();
        TableCell bodyRow1Cell2 = (TableCell) bodyRow1.getLastChild();
        assertThat(bodyRow1Cell1.getSourceSpans(), contains(SourceSpan.of(3, 2, 2)));
        assertThat(bodyRow1Cell2.getSourceSpans(), contains(SourceSpan.of(3, 4, 4)));

        TableRow bodyRow2 = (TableRow) body.getFirstChild().getNext();
        assertThat(bodyRow2.getSourceSpans(), contains(SourceSpan.of(4, 2, 8)));
        TableCell bodyRow2Cell1 = (TableCell) bodyRow2.getFirstChild();
        TableCell bodyRow2Cell2 = (TableCell) bodyRow2.getLastChild();
        assertThat(bodyRow2Cell1.getSourceSpans(), contains(SourceSpan.of(4, 2, 2)));
        assertThat(bodyRow2Cell2.getSourceSpans(), contains(SourceSpan.of(4, 4, 7)));

        TableRow bodyRow3 = (TableRow) body.getLastChild();
        assertThat(bodyRow3.getSourceSpans(), contains(SourceSpan.of(5, 1, 3)));
